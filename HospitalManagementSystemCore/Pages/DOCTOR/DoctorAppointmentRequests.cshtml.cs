...
{
    public class DoctorAppointmentRequestsModel : PageModel
    {
        private readonly HosDB HDB;
        private readonly ILogger<DoctorAppointmentRequestsModel> _logger;
        public DoctorAppointmentRequestsModel(ILogger<DoctorAppointmentRequestsModel> logger, HosDB HosDB)
        {
            _logger = logger;
            this.HDB = HosDB;
        }
